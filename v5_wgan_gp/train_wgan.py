"""
V5 WGAN-GP训练脚本
使用预训练的Flow Matching模型，用WGAN-GP专门优化多普勒效应
"""
import sys
import argparse
...
def main():
    parser = argparse.ArgumentParser(description="V5 WGAN-GP Training with Doppler Enhancement")
    ...
    # 创建训练器
    trainer = WGANTrainer(args.config, pretrained_path)
